...
<body style="margin-top: 30px; background-color: #DCDCDC;">
    <div class="container" style= "background-color: #000000; width: 30%; ">
        ...
        <div class="main">
            <form method="post" action="tam_login.php" enctype="multipart/form-data">    
                ...
                <input type="submit" name="submit" value="Simpan" class= "btn" style="background-color: #008080; color: #FFFFFF;">
            </form>
        </div>
    </div>
</body>
