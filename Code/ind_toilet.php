    ...
    <div class="container" class="container" style="background-color: #000000; width: 50%; padding: 30px;">
        ...
        <form>
            <div class="form-group" action="" method="get" >
                ...
                <button type="submit" name="submit" class="btn btn-primary" style="background-color: #008080;">Cari</button>
            </div>
        </form>
        </div>
        <div class="main">
            ...
            <tr>
                ...
                <td style="color: #FFFFFF;">
                    <button class="btn" type="button" style="background-color: #CD5C5C; width: 70%;"><a style="color: #FFFFFF;" href="hap_toilet.php?id=<?= $row['id'];?>">Hapus Data</a></button>
                </td>
            </tr>
            <?php endwhile; else: ?>
            <tr>
        ...
        <div>
        <button class="btn" type="button" style="background-color: #008080;"><a style="color: #FFFFFF" href="tam_toilet.php">Tambah Data Toilet</a></button>
        </div> <br>
        <div>
